...
logparamsGlobal += op.LogParam("Confirmed", 0, 4.2e6) #
logparamsGlobal += op.LogParam("Deaths", 0, 350e3) #
logparamsGlobal += op.LogParam("Active", 0, 3.0e6)
logparamsGlobal += op.LogParam("Recovered", 0, 1.5e6)
